  ...
  return (
    <div className="wrapper">
      ...
      <div className="skills third">
        ...
        <ul>
          <li>
            <img src="/src/assets/images/logos/html.png" alt="html logo" />
            <p className="effect blue">HTML5/CSS3</p>
          </li>
          <li>
            <img src="/src/assets/images/logos/js.png" alt="js logo" />
            <p className="effect blue">JavaScript</p>
          </li>
          <li>
            <img src="/src/assets/images/logos/react.png" alt="react logo" />
            <p className="effect blue">React.js</p>
          </li>
          <li>
            <img src="/src/assets/images/logos/redux.png" alt="redux logo" />
            <p className="effect blue">Redux</p>
          </li>
          <li>
            <img
              src="/src/assets/images/logos/wordpress.png"
              alt="wordpress logo"
            />
          ...
          <li>
            <img
              src="/src/assets/images/logos/bootstrap.png"
              alt="bootstrap logo"
            />
